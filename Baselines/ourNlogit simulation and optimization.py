...
cd_lifetime_rt = np.loadtxt('D:\\Manuscript 6 for e-commerce workshop\\2 data\\lifetime_default.csv')
...
data.to_csv("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\irr_distribution.csv", index=False)

# Part 3
# 10000 Events Generating using Monte-Carlo Simulation
data = pd.read_csv("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\irr_distribution.csv")
...
np.save('D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\monte_carlo_events.npy', mc)

# Part 4
# Replace Events with Conditional IRR
mc_dft = np.load('D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\monte_carlo_events.npy')
mc_ndft = 1 - mc_dft
data = pd.read_csv("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\irr_distribution.csv")
data = data.round(6)
...
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\default_irr.npy", default_irr)
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\claim_irr.npy", claim_irr)
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_dft.npy", mc_dft)
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_ndft.npy", mc_ndft)

# Memory Management
default_irr = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\default_irr.npy")
mc_dft = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_dft.npy")
default_irr = np.multiply(default_irr, mc_dft)
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_dft_irr.npy", default_irr)

claim_irr = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\claim_irr.npy")
mc_ndft = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_ndft.npy")
claim_irr = np.multiply(claim_irr, mc_ndft)
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_ndft_irr.npy", claim_irr)

mc_dft_irr = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_dft_irr.npy")
mc_ndft_irr = np.load("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_ndft_irr.npy")

mc_irr = mc_ndft_irr + mc_dft_irr
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_irr.npy", mc_irr)
...
# Part 1
# Data Preparation
mc_irr = np.load('D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\mc_irr.npy')
irr = pd.read_csv("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\irr_distribution.csv")
...
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\weights_0.95alpha", weights)
...
np.save("D:\\Manuscript 6 for e-commerce workshop\\5 our with logit\\ES_weights_0.95alpha", ES_weights)
